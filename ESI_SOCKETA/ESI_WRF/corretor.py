...
class Corretor():
    ...
    def __init__(self):
        ...
        self.WORDS = Counter(words(open('/home/ubuntu/Documents/ESI_SYNC_DB_RECOMENDATION/ESI_SOCKETA/ESI_WRF/resourcesToSearch/bigpt2.txt', encoding='utf-8').read().lower()))
