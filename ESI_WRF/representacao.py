...
class Representacao:
    global model
    def __init__(self):
        self.model = KeyedVectors.load_word2vec_format('C:\\Users\\AsusAugusto\\Documents\\ESI_SYNC_DB_RECOMENDATION\\ESI_WRF\\resourcesToSearch\\cbow_s50.txt', unicode_errors="ignore")
